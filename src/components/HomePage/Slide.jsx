                    ...
                    data.map(temp => (
                        <Link to={`product/${temp.id}`} style={{textDecoration: 'none'}}>
                            <Box textAlign="center" className={classes.wrapper}>
                                <img src={temp.images.image1} className={classes.image} alt="" />
                                <Typography className={classes.text} style={{ fontWeight: 600, color: '#212121' }}>{temp.title}</Typography>
                                <Typography className={classes.text} style={{ color: 'green' }}>upto {temp.discount}% off</Typography>
                                <Typography className={classes.text} style={{ color: '#212121', opacity: '.6' }}>{temp.brand}</Typography>
                            </Box>
                        </Link>
                    ))
                }
